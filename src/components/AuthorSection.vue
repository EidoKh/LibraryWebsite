            ...
            <div v-for="author in authors" :key="author">
                ...
                >
                    <div
                        ...
                        "
                    >
                        <div class="relative h-44 border-b-2 py-4">
                            <img
                                class="w-36 h-36 rounded-full mx-auto"
                                :src="
                                    APP_URL +
                                    '/images/authors_images/' +
                                    author.image
                                "
                            />
                        </div>
